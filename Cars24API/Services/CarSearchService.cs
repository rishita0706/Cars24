...
namespace Cars24API.Services
{
    ...
    public class CarSearchService
    {
        ...
        // Parsing moved to Utils/CarInsights.cs (shared with PricingService,
        // MaintenanceService) - call sites below now use CarInsights.ParseNumeric
        // / CarInsights.ParsePrice directly instead of these local wrappers.
